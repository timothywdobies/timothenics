    ...
    <Layout>
      ...
      <section className="relative bg-gradient-to-l from-gray-50 via-gray-50/50 to-white py-20 md:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Product Grid - 3 larger columns for more visual impact */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-[1400px] mx-auto">
            {products.map((product) => (
              ...
              >
                {/* Product card - larger for more visual impact */}
                <div className="relative aspect-[4/5] bg-[#f6f6f6] rounded-lg overflow-hidden flex items-center justify-center p-6 mb-6">
                ...
                <div className="text-center">
                  ...
                  <span className="inline-block bg-gray-200 text-gray-600 px-4 py-1.5 rounded-full text-xs font-medium uppercase tracking-wide">
                    Coming Soon
                  </span>
                </div>
              </div>
